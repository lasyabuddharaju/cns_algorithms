...
import {HillEncrypt,HillDecrypt} from './crypto'
...
const Hill = () => {
    ...
    const Encrypt =()=>{
        const res = HillEncrypt(plaintext,key)
        setCipherText(res)
    }
    const Decrypt =()=>{
        const res = HillDecrypt(plaintext,key)
        setCipherText(res)
    }
  return (
    <div>
...
<div className="monoalphabetic-container">
  <h1 className="monoalphabetic-title">Hill Cipher</h1>
